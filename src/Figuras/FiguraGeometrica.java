...
/**
 * Esta clase denominada FiguraGeométrica modela un figura geométrica que cuenta
 * con un volumen y una superficie a ser calculados de acuerdo al tipo de figura
 * geométrica.
 *
 * @version 1.2/2020
 */
public class FiguraGeometrica {
    ...
    /* Atributo que identifica el volumen de
una figura geométrica */
    private double superficie;

    /* Atributo que identifica la superficie de
una figura geométrica */
    /**
     ...
     *
     * @param superficie Parámetro que define la superficie de una figura
     * geométrica
     */
