...
/**
 * Esta clase denominada VentanaPirámide define una ventana para ingresar los
 datos de una pirámide y calcular su volumen y superficie.
 *
 * @version 1.2/2020
 */
...
// Se muestra el volumen
            volumen.setText(
                    "Volumen(cm3): " + String.format("%.2f", pirámide.calcularVolumen()
                    ));
