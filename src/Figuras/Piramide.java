...
/**
 * Esta clase denominada Pirámide es una subclase de FiguraGeométrica que cuenta
 * con una base, una altura y un apotema.
 *
 * @version 1.2/2020
 */
public class Piramide extends FiguraGeometrica {
    ...
    private double base;
    /* Atributo que identifica la base de una
pirámide */
    private double altura;

    private double apotema;

    /* Atributo que identifica el apotema de
una pirámide */
    /**
