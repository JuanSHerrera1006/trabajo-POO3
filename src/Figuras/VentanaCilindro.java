...
/**
 * Esta clase denominada VentanaCilindro define una ventana para ingresar los
 * datos de un cilindro y calcular su volumen y superficie.
 *
 * @version 1.2/2020
 */
...
// Se calcula y muestra el volumen
            volumen.setText(
                    "Volumen(cm3): " + String.format("%.2f", cilindro.calcularVolumen()));
